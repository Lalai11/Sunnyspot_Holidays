...
<body>
  <header>
    <div class="content header-flex">
      <a href="home.html"><img src="Images_png/SunnyspotLogo.png" alt="Sunny Spot Logo"></a>
      <div class="heading-1">
  ...
  <div class="gray-box page-2">
      <div class="content content-grid">
        <h2>Villas, cabins and camping</h2>
        <div>
          <p>Accommodation options at Sunny Spot Holiday Park include:</p>
          <ul>
            <li>18 cabins</li>
            <li>50 powered grass sites</li>
            <li>90 powered slab sites</li>
          </ul>
          <p>There are 18 different cabins to choose from. From standard cabins to the deluxe cabins only 50 metres from the beach. Cabin linen is provided for all guests.</p>
        </div>
      </div>
  </div> 
  <div class="galery img-border content">
  <?php
  ...
  ?>
      <!-- write HTML code with PHP variables inside the loop -->
      <div class="col">
        <div class="image-galery">
          <img class="img-size" src="cabins/<?= $photo;?>" alt="<?= $cType;?>">
        ...
        <p><?= $cDescription;?></p>
          <ul>
              <li>Price/night: $<?= $ppNight;?></li>
              <li>Price/week: $<?= $ppWeek;?></li>
          </ul>
        </div> 
      </div>       
